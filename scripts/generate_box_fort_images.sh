...
REF_URL="https://mule-router-assets.muleusercontent.com/router_public/production/ephemeral/3567fe9e-fc97-4eed-af30-5993e8edf032/result_00.png"
...
- Max: boy (6), sandy brown messy straight hair, light skin, round face, blue t-shirt, grey shorts, barefoot
- Mika: toddler girl (2), sandy brown curly hair in two small pigtails, light skin, chubby cheeks, purple shirt, green leggings, barefoot
- Max and Mika are siblings — same hair color and skin tone
- THE BOX: one large cardboard box, taller than Mika, big enough for both kids to sit inside
